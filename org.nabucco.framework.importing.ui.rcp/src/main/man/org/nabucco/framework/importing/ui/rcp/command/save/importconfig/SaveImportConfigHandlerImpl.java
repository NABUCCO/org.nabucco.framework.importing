 ...
 */
package org.nabucco.framework.importing.ui.rcp.command.save.importconfig;
...
import org.nabucco.framework.importing.ui.rcp.command.importconfig.save.SaveImportConfigHandler;
...
public class SaveImportConfigHandlerImpl extends
    ...
    protected void saveModel(ImportConfigEditViewModel viewModel, ImportConfigEditBusinessModel businessModel) {
        ...
        // importConfig.setMaintainServiceConfiguration(maintainConfig);
