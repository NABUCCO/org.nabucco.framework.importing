...
/**
 * ImportBrowseButtonListener
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public class ImportBrowseButtonListener extends SelectionAdapter {

    private static final String TITLE = "org.nabucco.framework.importing.wizard.dialog.browse";
    ...
    /**
     * Creates a new {@link ImportBrowseButtonListener} instance.
     * 
     * @param shell
     *            the shell
     * @param model
     *            the import model
     */
    public ImportBrowseButtonListener(Shell shell, ImportWizardModel model) {
        this.shell = shell;
        this.model = model;
    }
    ...
    public void widgetSelected(SelectionEvent e) {
        FileDialog dialog = new FileDialog(this.shell, SWT.OPEN | SWT.SHEET);
