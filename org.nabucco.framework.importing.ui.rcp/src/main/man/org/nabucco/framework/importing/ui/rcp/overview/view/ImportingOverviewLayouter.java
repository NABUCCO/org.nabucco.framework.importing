...
/**
 * ImportingOverviewLayouter
 * 
 * @author Christian Nicolaus, PRODYNA AG
 */
public class ImportingOverviewLayouter implements NabuccoLayouter {

    private ImportingOverviewWidgetFactory widgetFactory;
    ...
    public Composite layout(Composite parent, NabuccoMessageManager messageManager, ViewModel model) {
        if (model instanceof NabuccoOverviewModel) {
            return layout(parent, (NabuccoOverviewModel) model);
        }
        return null;
    }
    ...
    private Composite layout(Composite parent, NabuccoOverviewModel nabuccoOverviewModel) {
        ...
        widgetFactory = new ImportingOverviewWidgetFactory(ntk);
    ...
    private void createSectionBottom(Composite parent) {
        Section section = widgetFactory
                .createSectionHeadingAction(parent,
                        "org.nabucco.framework.importing.ui.rcp.overview.view.ImportingOverviewView.headingActions");
