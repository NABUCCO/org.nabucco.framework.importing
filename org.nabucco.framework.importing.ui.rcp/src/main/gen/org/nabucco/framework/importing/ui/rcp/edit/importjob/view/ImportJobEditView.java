...
/**
 * ImportJobEditView<p/><p/>
 *
 * @author Christian Nicolaus, PRODYNA AG, 2010-08-19
 */
public class ImportJobEditView extends EditView<ImportJobEditViewModel> {

    public static final String ID = "org.nabucco.framework.importing.ui.edit.importjob.ImportJobEditView";
    ...
    /** Constructs a new ImportJobEditView instance. */
    public ImportJobEditView() {
        super();
    }
    ...
    protected void createFormControl(Form form) {
        ...
        model = new ImportJobEditViewModel();
