...
/**
 * ImportConfigListViewWidgetFactory<p/>ListView for ImportConfiguration<p/>
 *
 * @author Christian Nicolaus, PRODYNA AG, 2010-08-20
 */
public class ImportConfigListViewWidgetFactory extends WidgetFactory {

    /**
     * Constructs a new ImportConfigListViewWidgetFactory instance.
     *
     * @param nabuccoFormToolKit the NabuccoFormToolkit.
     */
    public ImportConfigListViewWidgetFactory(NabuccoFormToolkit nabuccoFormToolKit) {
