...
/**
 * ImportConfigSearchViewImportTypeContentProvider<p/>search view for an import configuration<p/>
 *
 * @author Christian Nicolaus, PRODYNA AG, 2010-08-20
 */
public class ImportConfigSearchViewImportTypeContentProvider implements ElementPickerContentProvider {

    /** Constructs a new ImportConfigSearchViewImportTypeContentProvider instance. */
    public ImportConfigSearchViewImportTypeContentProvider() {
        super();
    }
