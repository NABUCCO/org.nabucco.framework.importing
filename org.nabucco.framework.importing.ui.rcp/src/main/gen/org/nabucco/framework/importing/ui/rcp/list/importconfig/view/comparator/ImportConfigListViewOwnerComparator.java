...
/**
 * ImportConfigListViewOwnerComparator
 *
 * @author Undefined
 */
public class ImportConfigListViewOwnerComparator extends NabuccoColumComparator<ImportConfiguration> {

    /** Constructs a new ImportConfigListViewOwnerComparator instance. */
    public ImportConfigListViewOwnerComparator() {
        super();
    }
