...
/**
 * ImportConfigListViewNameComparator
 *
 * @author Undefined
 */
public class ImportConfigListViewNameComparator extends NabuccoColumComparator<ImportConfiguration> {

    /** Constructs a new ImportConfigListViewNameComparator instance. */
    public ImportConfigListViewNameComparator() {
        super();
    }
