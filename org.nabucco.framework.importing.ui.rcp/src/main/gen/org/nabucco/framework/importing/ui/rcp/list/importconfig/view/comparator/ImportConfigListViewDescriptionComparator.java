...
/**
 * ImportConfigListViewDescriptionComparator
 *
 * @author Undefined
 */
public class ImportConfigListViewDescriptionComparator extends NabuccoColumComparator<ImportConfiguration> {

    /** Constructs a new ImportConfigListViewDescriptionComparator instance. */
    public ImportConfigListViewDescriptionComparator() {
        super();
    }
