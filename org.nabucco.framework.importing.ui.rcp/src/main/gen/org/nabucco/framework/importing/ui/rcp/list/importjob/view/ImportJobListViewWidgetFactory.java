...
/**
 * ImportJobListViewWidgetFactory<p/>ListView for ImportJob<p/>
 *
 * @author Christian Nicolaus, PRODYNA AG, 2010-08-20
 */
public class ImportJobListViewWidgetFactory extends WidgetFactory {

    /**
     * Constructs a new ImportJobListViewWidgetFactory instance.
     *
     * @param nabuccoFormToolKit the NabuccoFormToolkit.
     */
    public ImportJobListViewWidgetFactory(NabuccoFormToolkit nabuccoFormToolKit) {
