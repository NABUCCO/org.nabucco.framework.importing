...
/**
 * ImportConfigListViewTableFilter<p/>ListView for ImportConfiguration<p/>
 *
 * @author Christian Nicolaus, PRODYNA AG, 2010-08-20
 */
public class ImportConfigListViewTableFilter extends NabuccoTableFilter {

    /** Constructs a new ImportConfigListViewTableFilter instance. */
    public ImportConfigListViewTableFilter() {
        super();
    }
