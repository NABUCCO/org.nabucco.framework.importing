...
/**
 * ImportJobListView<p/>ListView for ImportJob<p/>
 *
 * @author Christian Nicolaus, PRODYNA AG, 2010-08-20
 */
public class ImportJobListView extends NabuccoComponentListView<ImportJobListViewModel> {

    public static final String ID = "org.nabucco.framework.importing.ui.list.importjob.ImportJobListView";

    public static final String TAB_TITLE = (ID + ".tabTitle");

    public static final String TITLE = (ID + ".title");

    /** Constructs a new ImportJobListView instance. */
    public ImportJobListView() {
        super();
        model = new ImportJobListViewModel();
    }
