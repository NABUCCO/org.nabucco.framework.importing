...
import org.nabucco.framework.importing.ui.rcp.list.importconfig.model.ImportConfigListViewModel;
...
/**
 * ImportConfigListView<p/>ListView for ImportConfiguration<p/>
 *
 * @author Christian Nicolaus, PRODYNA AG, 2010-08-20
 */
public class ImportConfigListView extends NabuccoComponentListView<ImportConfigListViewModel> {
    ...
    /** Constructs a new ImportConfigListView instance. */
    public ImportConfigListView() {
        super();
        model = new ImportConfigListViewModel();
    }
