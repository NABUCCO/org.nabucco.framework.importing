...
/**
 * ImportTypePickerContentProviderHandler<p/><p/>
 *
 * @author Christian Nicolaus, PRODYNA AG, 2010-08-19
 */
public interface ImportTypePickerContentProviderHandler extends NabuccoInjectable {
     ...
     */
    Map<String, ImportConfiguration[]> loadAllImportConfiguration();
}
