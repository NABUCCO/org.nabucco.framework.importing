...
/**
 * ImportConfigurationListViewOwnerComparator
 *
 * @author Undefined
 */
public class ImportConfigurationListViewOwnerComparator extends
        NabuccoColumComparator<ImportConfiguration> {

    /** Constructs a new ImportConfigurationListViewOwnerComparator instance. */
    public ImportConfigurationListViewOwnerComparator() {
        super();
    }
