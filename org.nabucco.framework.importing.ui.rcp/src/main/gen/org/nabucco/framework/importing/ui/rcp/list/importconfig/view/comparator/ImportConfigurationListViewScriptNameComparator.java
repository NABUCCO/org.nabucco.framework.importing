...
/**
 * ImportConfigurationListViewScriptNameComparator
 *
 * @author Undefined
 */
public class ImportConfigurationListViewScriptNameComparator extends
        NabuccoColumComparator<ImportConfiguration> {

    /** Constructs a new ImportConfigurationListViewScriptNameComparator instance. */
    public ImportConfigurationListViewScriptNameComparator() {
        super();
    }
