...
/**
 * ImportConfigEditView<p/>the import configuraton edit view<p/>
 *
 * @author Christian Nicolaus, PRODYNA AG, 2010-08-19
 */
public class ImportConfigEditView extends EditView<ImportConfigEditViewModel> {

    public static final String ID = "org.nabucco.framework.importing.ui.edit.importconfig.ImportConfigEditView";
    ...
    /** Constructs a new ImportConfigEditView instance. */
    public ImportConfigEditView() {
        super();
    }
    ...
    protected void createFormControl(Form form) {
        ...
        model = new ImportConfigEditViewModel();
