...
/**
 * ImportConfigurationListViewDescriptionComparator
 *
 * @author Undefined
 */
public class ImportConfigurationListViewDescriptionComparator extends
        NabuccoColumComparator<ImportConfiguration> {

    /** Constructs a new ImportConfigurationListViewDescriptionComparator instance. */
    public ImportConfigurationListViewDescriptionComparator() {
        super();
    }
