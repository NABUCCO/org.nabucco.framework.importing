...
/**
 * ImportJobSearchView<p/>@TODO<p/>
 *
 * @author Christian Nicolaus, PRODYNA AG, 2010-08-20
 */
public class ImportJobSearchView extends AbstractNabuccoSearchView<ImportJobSearchViewModel> implements
        NabuccoSearchView {

    private ImportJobSearchViewModel model;

    public static final String ID = "org.nabucco.framework.importing.ui.search.importjob.ImportJobSearchView";

    /** Constructs a new ImportJobSearchView instance. */
    public ImportJobSearchView() {
        super();
        model = new ImportJobSearchViewModel(this.getCorrespondingListView());
    }
    ...
    @Override
    public ImportJobSearchViewModel getModel() {
        return model;
    }

    @Override
    public String getId() {
        return ImportJobSearchView.ID;
    }
}
