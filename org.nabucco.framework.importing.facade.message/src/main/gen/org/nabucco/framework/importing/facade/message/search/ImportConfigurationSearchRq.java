...
/**
 * ImportConfigurationSearchRq<p/>Search message for searching ImportConfiguration instances / entities<p/>
 *
 * @version 1.0
 * @author Lasse Asbach, PRODYNA AG, 2010-07-23
 */
public class ImportConfigurationSearchRq extends ServiceMessageSupport implements ServiceMessage {
    ...
    /** Name of the ImportConfiguration. */
    private Name name;

    /** Owner of the ImportConfiguration. */
    private Owner owner;

    /** Description of the ImportConfiguration. */
    private Description description;

    /** Name of the used script in the ImportConfiguration. */
    private Name scriptName;

    /** Type of the data to import. */
    private ImportType importType;

    /** Constructs a new ImportConfigurationSearchRq instance. */
    public ImportConfigurationSearchRq() {
        super();
        this.initDefaults();
    }
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(IMPORTTYPE, PropertyDescriptorSupport.createEnumeration(IMPORTTYPE, ImportType.class, 4,
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(ImportConfigurationSearchRq.getPropertyDescriptor(NAME), this.name));
        properties.add(super.createProperty(ImportConfigurationSearchRq.getPropertyDescriptor(OWNER), this.owner));
        properties.add(super.createProperty(ImportConfigurationSearchRq.getPropertyDescriptor(DESCRIPTION),
                this.description));
        properties.add(super.createProperty(ImportConfigurationSearchRq.getPropertyDescriptor(SCRIPTNAME),
                this.scriptName));
        properties.add(super.createProperty(ImportConfigurationSearchRq.getPropertyDescriptor(IMPORTTYPE),
                this.getImportType()));
        return properties;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final ImportConfigurationSearchRq other = ((ImportConfigurationSearchRq) obj);
        if ((this.name == null)) {
            if ((other.name != null))
                return false;
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(ImportConfigurationSearchRq.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(ImportConfigurationSearchRq.class).getAllProperties();
    }
}
